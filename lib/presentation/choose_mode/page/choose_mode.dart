...
class _ChooseModePageState extends State<ChooseModePage> {
  ...
  Widget _buildModeOption(BuildContext context,
      {required String mode, required String icon, required VoidCallback onTap}) {
    return Column(
      children: [
        GestureDetector(
          onTap: onTap,
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: _selectedMode == mode
                      ...
                      : const Color(0xff30393C).withOpacity(0.4),
        ...
        Text(
          ...
          style: TextStyle(
            ...
            fontSize: 17,
            color: _selectedMode == mode ? Colors.green : AppColors.grey,
          ),
        ),
      ],
    );
